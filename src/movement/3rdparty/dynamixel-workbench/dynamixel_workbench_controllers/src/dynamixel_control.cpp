...
#include "dynamixel_workbench_controllers/dynamixel_control.h"
...
bool DynamixelControl::loadDynamixel()
{
  bool ret = false;
...
bool DynamixelControl::setTorque(bool onoff)
{
...
bool DynamixelControl::setProfileValue(uint32_t prof_vel, uint32_t prof_acc)
{
...
bool DynamixelControl::setPosition(uint32_t pan_pos, uint32_t tilt_pos)
{
...
bool DynamixelControl::checkLoadDynamixel()
{
  ROS_INFO("-----------------------------------------------------------------------");
...
bool DynamixelControl::initDynamixelStatePublisher()
{
  dynamixel_state_list_pub_ = node_handle_.advertise<dynamixel_workbench_msgs::DynamixelStateList>("/dynamixel_control/dynamixel_state", 10);
}

bool DynamixelControl::initDynamixelInfoServer()
{
  joint_command_server = node_handle_.advertiseService("/joint_command", &DynamixelControl::jointCommandMsgCallback, this);

}

bool DynamixelControl::readDynamixelState()
{
...
bool DynamixelControl::dynamixelStatePublish()
{
  readDynamixelState();
...
uint32_t DynamixelControl::convertRadian2Value(float radian)
{
  uint32_t value = 0;
...
bool DynamixelControl::controlLoop()
{
  dynamixelStatePublish();
}

bool DynamixelControl::jointCommandMsgCallback(dynamixel_workbench_msgs::JointCommand::Request &req,
