class PossibleMovementsList():
    ...
    def __init__(self):
        ...
        self.walking_movements_listed = ["nothing_request", "walk_forward", "rotate_clockwise", "rotate_counter_clockwise"]
        ...
        self.other_movements_listed = ["body_alignment_to_left", "body_alignment_to_right", "emergency_shutdown", "stop_all_motions"]
        
        self.all_movements_listed = self.walking_movements_listed + self.page_movements_listed + self.moving_head_movements_listed + self.other_movements_listed
