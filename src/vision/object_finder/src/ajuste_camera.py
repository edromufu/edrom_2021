...
##### Setar o id da câmera (0 para webcam) #####
camera = 0
...
while True:
    ...
    if key == ord('.'):
        focus = focus + 50
        print(s_video.set(cv2.CAP_PROP_FOCUS, (focus)))  # Focus
    ...
    if key == ord('='):
        bright = bright + 50
        print(s_video.set(cv2.CAP_PROP_BRIGHTNESS, (bright)))
