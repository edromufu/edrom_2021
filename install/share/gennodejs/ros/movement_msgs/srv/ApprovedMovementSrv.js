...
class ApprovedMovementSrvRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ApprovedMovementSrvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ApprovedMovementSrvRequest
    let len;
    let data = new ApprovedMovementSrvRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ApprovedMovementSrvRequest(null);
...
class ApprovedMovementSrvResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.response = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ApprovedMovementSrvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ApprovedMovementSrvResponse
    let len;
    let data = new ApprovedMovementSrvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ApprovedMovementSrvResponse(null);
...
module.exports = {
  Request: ApprovedMovementSrvRequest,
  Response: ApprovedMovementSrvResponse,
  md5sum() { return '96a28d2e667000a662371cc5689381d0'; },
  datatype() { return 'movement_msgs/ApprovedMovementSrv'; }
};
