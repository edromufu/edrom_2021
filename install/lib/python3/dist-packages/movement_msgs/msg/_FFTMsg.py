...
"""autogenerated by genpy from movement_msgs/FFTMsg.msg. Do not edit."""
import codecs
import sys
...
class FFTMsg(genpy.Message):
  _md5sum = "920b50939e8ceb599da8e34c404bba26"
  _type = "movement_msgs/FFTMsg"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FFTMsg, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.df,) = _get_struct_d().unpack(str[start:end])
      return self
