...
(cl:defmethod description-val ((m <BehRequestSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movement_msgs-srv:description-val is deprecated.  Use movement_msgs-srv:description instead.")
  (description m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BehRequestSrv-request>)))
  ...
  "ee7d6e8b98e6646580b37e2806895049")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BehRequestSrv-request)))
  "Returns md5sum for a message object of type 'BehRequestSrv-request"
  "ee7d6e8b98e6646580b37e2806895049")
