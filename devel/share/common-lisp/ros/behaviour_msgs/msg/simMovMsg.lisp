...
(cl:defmethod cl:initialize-instance :after ((m <simMovMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'simMovMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name behaviour_msgs-msg:<simMovMsg> is deprecated: use behaviour_msgs-msg:simMovMsg instead.")))

(cl:ensure-generic-function 'positions-val :lambda-list '(m))
(cl:defmethod positions-val ((m <simMovMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader behaviour_msgs-msg:positions-val is deprecated.  Use behaviour_msgs-msg:positions instead.")
  (positions m))
